                                       ...
                                       <td>
                                          ...
                                          @endif
                                             ...
                                             <div class="dropdown-menu">
                                                <!-- helper to get mark option on priority basis -->
                                                @if(count(get_lead_types($d->lead_type)))
                                                ...
                                                <div class="modal-body text-center">
                                                   <div class="row mb-3">
                                                      ...
                                                      <div class="col-auto col-md-6">
                                                         ...
                                                         <input class="form-check-input enq_type" type="radio" name="enquiry_type" id="c_type" value="{{$cl_type->id}}" disabled 
                                                         <?php
                                                      ...
                                                      <div class="col-md-4 mt-2">
                                                         ...
                                                         <input type="text" class="form-control "  id="cus_email{{$d->id}}" name="cus_email" value="{{$d->cust_email}}" readonly>
                                                      </div>
                                                      <div class="col-md-4 mt-2">
                                                         <label for="cus_mobile<?= $d->id ?>">Customer Contact Number<span class="important d-inline"></span></label>
                                                         <input type="text" class="form-control "  id="cus_mobile{{$d->id}}" name="cus_mobile" value="{{$d->cust_mobile}}"  readonly>
                                                      ...
                                                      <div class="col-md-4 mt-2">
                                                         <label for="type">Travel Type <span class="important"></span></label><br/>
                                                            <select class="form-control" name="type[]" data-live-search="true" multiple id="type" requird  data-width="100%" disabled>
                                                                  <!-- <option value=""></option> -->
                                                               @php $type = array();
                                                         ...
                                                         <div class="mb-3">
                                                            ...
                                                            <div class="row" style="padding:0px 10px">
                                                               <div class="col-xl-4 p-0">
                                                                  <select class="form-select digits" id="budget_type" name="budget_type" disabled>
                                                               ...
                                                               <div class="col-xl-4 p-0">
                                                                  <input type="text" class="form-control" id="budget_value" name="budget_value" value="{{$d->budget_payment_value}}" readonly>
                                                      ...
                                                      <div class="col-xl-4">
                                                            <div class="mb-3">
                                                               ...
                                                               <div class="row" style="padding:0px 10px;">
                                                                  <div class="col-xl-4 p-0">
                                                                     <input type="text" class="form-control" id="adults{{$d->id}}" name="adults" value="{{$d->adults}}" placeholder="Adults" readonly
                                                                     >
                                                                  </div>
                                                                  <div class="col-xl-4 p-0">
                                                                     <input type="text" class="form-control" id="kids" name="kids" value="{{$d->kids}}" placeholder="Kids" readonly
                                                                     >
                                                                  </div>
                                                                  <div class="col-xl-4 p-0">
                                                                     <input type="text" class="form-control" id="infants" name="infants" value="{{$d->infants}}" placeholder="Infants" readonly
                                                                     >
                                                                  </div>
                                                               </div>
                                                            </div>
                                                         ...
                                                         <div class="col-md-4 mt-2">
                                                            <label for="hname">Lead Source <span class="important"></span></label><br/>
                                                               <select name="lead_source[]" class="form-control" data-live-search="true"  id="lead_source"  data-width="100%" multiple disabled>
                                                               @php $type = array();
                                                         ...
                                                         <div class="col-md-4 mt-2">
                                                            ...
                                                            <select name="lead_owner[]" class="form-control" data-live-search="true"  id="lead_owner"   data-width="100%" multiple disabled>
                                                               @php $type = array();
                                          ...
                                          <div class="modal-content">
                                             ...
                                             <div class="modal-body text-center">
                                                ...
                                                <form action="{{url('crm/modify/lead')}}" method="post">
                                                   ...
                                                   <div class="form-group text-center">
                                                      <input type="hidden" name="hide_id" value="{{$d->id}}">
                                                      <input type="hidden" name="assign_to" id="assign_to{{$d->id}}"value="">
