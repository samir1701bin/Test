                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                               <a class="btn btn-primary btn-sm" href="{{url('client/create_client')}}" style="float:right">+ Add Client</a>
                                                            </div>
                                                                        ...
                                                                        <table class="datatable table table-striped table-bordered nowrap">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a  href="client/client_profile"><button class="btn btn-primary btn-sm"> View</button></a></td>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table  class="datatable table table-striped table-bordered nowrap">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><a
                                                                                            href="client/client_profile"><button
                                                                        ...
                                                                        <table class="datatable table table-striped table-bordered nowrap">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><a href="client/client_profile"><button
                                                                                                class="btn btn-primary btn-sm">
                                                                                                View</button></a></td>
                                                                                    </td>
                                                                                </tr>
