            										...
            										<div class="card">
            											<div class="card-header">
            													<div class="row">
            														<div class="col-md-8 col-12">
                														<h4> Payable to Supplier </h4>
                													</div>
            														<div class="col-md-4 col-12">
            														    <a href="#" class="btn btn-primary btn-sm" style="float:right">Create New Vendor Payment</a>
                													</div>
            												</div>
            											<div class="card-block">
            											        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                                  ...
                                                                  <li class="nav-item">
                                                                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#next1month" role="tab" aria-controls="contact" aria-selected="false">Next 6 Months</a>
                                                                  </li>
                                                                  <li class="nav-item">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                          <div class="tab-content" id="myTabContent">
                                                                              ...
                                                                              <div class="tab-pane fade" id="next15days" role="tabpanel" aria-labelledby="profile-tab">
                                                                                   <div class="row">
                                                                                      <div class="col-md-12">
                                                                                          <div class="row">
                                                                                              <div class="col-md-3 col-6">
                                                                              ...
                                                                              <div class="tab-pane fade" id="thismonth" role="tabpanel" aria-labelledby="contact-tab"> <div class="row">
                                                                              ...
                                                                              <div class="tab-pane fade" id="next1month" role="tabpanel" aria-labelledby="contact-tab"> <div class="row">
                                                                                      <div class="col-md-12">
                                                                                          <div class="row">
                                                                                              <div class="col-md-3 col-6">
                                                                                                  <div class="counter-section">
                                                                              ...
                                                                              <div class="tab-pane fade" id="next12month" role="tabpanel" aria-labelledby="contact-tab"> <div class="row">
                                                                                    <div class="col-md-12">
                                                                                          <div class="row">
                                                                                              <div class="col-md-3 col-6">
                                                                                                  <div class="counter-section">
